...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // https://jestjs.io/pt-BR/docs/using-matchers#n%C3%BAmeros - passado na aula ao vivo com Gian!
    ...
    // toEqual recursivamente verifica cada campo de um objeto ou array. - https://jestjs.io/pt-BR/docs/using-matchers
